...
const SideBar = ({ onSectionChange }: { onSectionChange: (section: string) => void }) => {
  ...
  return (
    <div className=" fixed p-6 py-8 w-76 md:w-[250px] md:p-8 bg-white border-r h-screen text-[17px]">
      ...
      <div className="mt-6">
        ...
        {/* <SidebarItems text="Tags" icon={<HashTagIcon size="md" />} onClick={() => onSectionChange("tags")} /> */}
      </div>
    </div>
  );
};
